...
class Find(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(300, 30, 500, 81))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(660, 150, 151, 41))
        self.pushButton_3.setStyleSheet("font: 22px;")
        self.pushButton_3.setObjectName("pushButton_3")


        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(295, 280, 411, 421))
        ...
        self.label_result.setGeometry(QtCore.QRect(50, 740, 900, 60))
        ...
        # self.label_4.setGeometry(QtCore.QRect(540, 280,411, 421))
        ...
        self.label_5.setGeometry(QtCore.QRect(455, 240, 91, 31))
        self.label_5.setStyleSheet("font: 14pt \"Arial\";")
        self.label_5.setObjectName("label_5")
        # self.label_6 = QtWidgets.QLabel(self.centralwidget)
        # self.label_6.setGeometry(QtCore.QRect(710, 240, 85, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "who is this guy?"))
        self.pushButton_3.setText(_translate("MainWindow", "start"))



        self.label_5.setText(_translate("MainWindow", "image"))
        # self.label_6.setText(_translate("MainWindow", "professor"))
    ...
    def startAction(self):
        ...
        print(imgNamepath)
        # image_files = os.glob(os.path.join(dataset_path, "**/*.jpg"), recursive=True)
        # for img in image_files:
        try:
            print(imgNamepath)
            obj=DeepFace.find(imgNamepath,dataset_path,enforce_detection=False)
            if(len(obj[0]))<=5:
                self.label_result.setText("Sorry, maybe you're not in our dataset")

            else:
                img_find = obj[0]["identity"][0]
                img_path = dataset_path+'/'+os.path.basename(img_find)
                ...
                if(person=="noise"):
                    ...
                    self.label_result.setText("Welcome! "+ person )
