...
class Find(object):
    def setupUi(self, MainWindow):
        ...
        self.label_2.setGeometry(QtCore.QRect(147, 30, 700, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_2.setText(_translate("MainWindow", "the professor you look like most"))
    ...
    def startAction(self):
        dataset_path = "professor_SUSTech"

        obj=DeepFace.find(imgNamepath,dataset_path,enforce_detection=True)
