...
class Find(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2_1.clicked.connect(self.select_dataset)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_2_1.setText(_translate("MainWindow", "dataset"))

        self.label_2.setText(_translate("MainWindow", "find matching"))
        self.pushButton_3.setText(_translate("MainWindow", "start"))



        self.label_5.setText(_translate("MainWindow", "image"))
        self.label_6.setText(_translate("MainWindow", "dataset"))
    ...
    def select_dataset(self):
        global dataset_path
        dataset_path=QFileDialog.getExistingDirectory(self.centralwidget, "选择文件夹")
        self.lineEdit_3_1.setText(dataset_path)
    ...
    def startAction(self):
        try:
            ...
            img = QtGui.QPixmap(img_path).scaled(self.label_4.width(), self.label_4.height())
            self.label_4.setPixmap(img)
            self.label_result.setText(os.path.basename(img_find))
        except Exception:
            self.label_4.setText("no matching faces!")
